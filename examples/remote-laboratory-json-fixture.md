# Remote laboratory JSON fixture

Complete metadata fixture for a short-duration remote laboratory. The raw JSON
file remains available at [`remote-lab.json`](remote-lab.json) for integration
