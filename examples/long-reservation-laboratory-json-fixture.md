# Long-reservation laboratory JSON fixture

Complete metadata fixture for a remote environmental chamber with reservations
lasting from one to fourteen days. The raw JSON file remains available at
[`long-reservation-lab.json`](long-reservation-lab.json) for integration tests
...
```json
{
  ...
  "attributes": [
    ...
    {"trait_type": "unavailableWindows", "value": [
      {"startUnix": 1789344000, "endUnix": 1789430400, "reason": "Annual chamber calibration"}
    ]}
  ]
}
```
